...
//    }
     ...
     * @param height
     */
    public static void resizeViewGroupViewSize(ViewGroup view, int width, int height) {
        ViewGroup.LayoutParams bannerlayout = (ViewGroup.LayoutParams) (view.getLayoutParams());
//        bannerlayout.width = width;
        bannerlayout.height = height;
        view.setLayoutParams(bannerlayout);
    }
...
//        GridLayout.LayoutParams bannerlayout = (GridLayout.LayoutParams) (view.getLayoutParams());
     ...
     * @param height
     */
    public static void resizeLinearLayoutViewSize0(View view, int width, int height,int left,int top,int right,int bottom) {
        LinearLayout.LayoutParams bannerlayout =  new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        bannerlayout.width = width;
        bannerlayout.height = height;
    ...
    public static void resizeLinearLayoutViewHeightSize1(LinearLayout view, int height) {
        Log.e("Mars","resizeLinearLayoutViewHeightSize_height: "+ height);
     ...
     * @param height
     */
    public static void resizeImageViewSize(ImageView view, int width, int height,int left) {
